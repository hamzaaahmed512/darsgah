...
export function DashboardHeader({
  ...
  return (
    <section
      className="mb-8 overflow-hidden rounded-[18px] border border-slate-200 bg-white px-5 py-5 text-slate-900 shadow-sm sm:px-6"
      data-role={role}
    >
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex min-w-0 items-start gap-3 sm:items-center sm:gap-4">
          ...
          <div className="min-w-0">
            ...
            <h1 className="mt-2 truncate font-display text-xl font-bold text-slate-900 sm:text-2xl">
        ...
        <div className="border-t border-slate-200 pt-4 text-left lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0 lg:text-right">
          <p className="text-sm font-semibold text-slate-600">{date}</p>
          <time className="mt-1 block font-mono text-2xl font-bold tracking-wide text-slate-900">{time}</time>
        </div>
      </div>
    </section>
  );
