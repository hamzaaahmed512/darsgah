...
const sections = [
  ...
  ["2. Information you provide", "We may receive information you choose to share, such as your name, work email address, school name, role, and the contents of an enquiry. The contact form on this website prepares a message in your own email application; the website itself does not store that form submission."],
