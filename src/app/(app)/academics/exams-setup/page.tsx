...
export default async function ExamsSetupPage() {
  ...
  return <>
    ...
    <section className="grid gap-5 lg:grid-cols-3">
      ...
      <Card><CardHeader><CardTitle>Special Exams</CardTitle><ClipboardPenLine className="h-5 w-5 text-primary" /></CardHeader><CardContent className="space-y-4"><p className="text-sm leading-6 text-muted">Special exam tasks are configured by the principal and appear in the assigned teacher account assessment register.</p><Badge tone="blue">Principal controlled</Badge></CardContent></Card>
