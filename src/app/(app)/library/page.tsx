...
export default async function LibraryPage() {
  ...
  return <><PageHeader eyebrow="Operations" title="Library" description="A place for every book. A clear record of every loan." descriptionClassName="hidden sm:block" />
